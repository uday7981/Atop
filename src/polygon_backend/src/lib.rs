...
// const URL: &str = "https://polygon-mumbai.g.alchemy.com/v2/_wTBt1-Y4z8wV2D8cgAMp6QOGnSCZ9Au";
const URL: &str = "https://polygon-mumbai.g.alchemy.com/v2/XcG0U49rmR40kygsOE2Z2MrqtZxXYjGS";
const CHAIN_ID: u64 = 80001;
const KEY_NAME: &str = "dfx_test_key";
// const URL_POLYGON : &str = "https://eth-sepolia.g.alchemy.com/v2/eSvwWtgUFPq3xCErmU5h7zriE3UGCAUE";
const URL_POLYGON : &str = "https://opt-sepolia.g.alchemy.com/v2/6h3ymoWYmvZMq4ub7mqbdCMWJG8-GZ_v";
...
async fn main_task() -> Result<String, String> {
    ...
    // let latestBlockString = format!("{}",latestBLockNumber);// Candid Nat as a string
    ...
    ic_cdk::println!("polygon block string poly {}",block_string);
    ic_cdk::println!("polygon block_uint {}",block_uint);
    let correctBlock = if Nat::from(0) == latestBLockNumber  {"earliest"} else { &block_string };

    // let body = "{\"jsonrpc\": \"2.0\",\"method\": \"eth_getLogsparams\": [{\"fromBlock\": \"earliest\",\"toBlock\": \"latest\",\"address\":\"0xe7399b79838acc8caaa567fF84e5EFd0d11BB010\",\"topics\":[\"0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef\"]}],\"id\": 1}";
    ...
    let unformated_body: &str = "{\"jsonrpc\": \"2.0\",\"method\": \"eth_getLogs\",\"params\": [{\"fromBlock\": \"#\",\"toBlock\": \"latest\",\"address\":\"0x3E4c15FE9b267CF94E8241EbEaB7a447031a35C5\",\"topics\":[\"0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef\"]}],\"id\": 1}";
    let body = unformated_body.replace("#",&correctBlock);
    ic_cdk::println!("poly body: {}", body);
    ...
    if(logResponse.len()==0){
        ic_cdk::println!("Polygon no transaction at all");
    ...
    if (Nat::from(lastestBlack) > latestBLockNumber ){
        ...
        let poly_contract_address: &str = "0xFB85026860c2Db45c9E8409aCC7CBE86b8196EBc";
